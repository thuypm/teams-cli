      ...
      <div class="row">
        ...
        <div class="col-3">
          ...
          <div>
            <form action style="text-align: left">
              ...
              <h5 style="padding-top: 20px">Đánh giá của bạn cho bài tập của {{}}</h5>
              <textarea name placeholder="Nhận xét" style="width:100%" rows="5"></textarea>
        ...
        <div class="col-2">
          ...
          <button class="btn btn-outline-success">
            <i class="fa fa-plus"></i> Thêm bài tập mới
          </button>
        </div>
      </div>
    </div>
